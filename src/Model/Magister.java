...
public class Magister extends Mahasiswa {
    ...
    public Magister(String nama, int NIM, String jurusan, String alamat, String TTL, String telepon, String judulTesis, ArrayList<MatkulAmbil> listMataKuliahMagister) {
