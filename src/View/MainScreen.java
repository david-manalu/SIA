...
public class MainScreen {
    ...
    public MainScreen() {
        ...
        JOptionPane.showMessageDialog(null, "Selamat datang", "SISTEM INFORMASI AKADEMIK", JOptionPane.INFORMATION_MESSAGE);
        int menuUtama = 0;
        int menuAdmin = 0;
        int menuMhs = 0;
        ...
        while (menuUtama != 3) {
            ...
            switch (menuUtama) {
                    ...
                    while (menuAdmin != 8) {
                        ...
                        switch (menuAdmin) {
                            ...
                            case 3:// Print Rata" Nilai Akhir (NR) Seluruh Mhs Per Matkul
                                kodeMKinput = i.inputKodeMK();
                                c.printRataNilaiAkhirAllMhs(kodeMKinput);
                ...
                case 3:
                    JOptionPane.showMessageDialog(null, "Terima kasih! \nExit Program!", "SISTEM INFORMASI AKADEMIK", JOptionPane.INFORMATION_MESSAGE);
                    break;
                default:
                    JOptionPane.showMessageDialog(null, "Wrong Input!");
                    break;
